...
MODEL_SAVE_PATH = pl.Path("models/xgb_quality_smote.json")
...
def main():
    ...
    print(f"After SMOTE oversampling: {len(X_resampled)}")

    # Train XGBoost without class weighting (SMOTE balanced classes)
    model = xgb.XGBClassifier(
        ...
        n_estimators=800,
        subsample=0.8,
        scale_pos_weight=1,  # no need to balance here after SMOTE
